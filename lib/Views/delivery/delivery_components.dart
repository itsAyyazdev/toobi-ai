...
class DeliveryComponent{
  ...
  static Widget CustomContainer({required String image, required String title}) {
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Stack(
          children: [
            Image.asset(image,fit: BoxFit.fill,height: 96.h,width: 338.w,),
            ...
            Padding(
              ...
              child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  ...
                  Icon(Icons.arrow_forward_ios_rounded,color: AppColors.iconwhiteColor,)
                ],
              ),
            )
          ],
  ...
  static Widget CustomWebContainer({required String image, required String title}) {
    return GestureDetector(
      onTap: (){
        Get.to(()=>Categories(title: title,image: image,));
      },
      child: Container(
        ...
        child: Stack(
          children: [
            Image.asset(image,fit: BoxFit.fill,height: 189.h,width: 504.w,),
            ...
            Padding(
              ...
              child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  ...
                  Icon(Icons.arrow_forward_ios_rounded,color: AppColors.iconwhiteColor, size: 15.sp,)
                ],
              ),
            )
          ],
